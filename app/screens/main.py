...
class ScreenMain(LcarsScreen):
    def setup(self, all_sprites):
        ...
        all_sprites.add(LcarsButton(colours.PEACH, (107, 398), "WEATHER", self.weatherHandler),
                        layer=4)
        all_sprites.add(LcarsButton(colours.PEACH, (107, 534), "ALARM ON", self.AlarmOnHandler),
                        layer=4)
        all_sprites.add(LcarsButton(colours.PEACH, (107, 670), "ALARM OFF", self.AlarmOffHandler),
                        layer=4)
    ...
    def AlarmOnHandler(self, item, event, clock):
        from datasources.alarmrelay import AlarmOn
        AlarmOn()
